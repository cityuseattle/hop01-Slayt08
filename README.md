...
- ```mkdir IS312```(to create a directory for this course)<br/>
- ```cd IS312```(to change directory to IS312 you just created) </br>
...
KimNguyen/Desktop/IS312/HOP01-KimNguyenMai/Module 1 <br/>
